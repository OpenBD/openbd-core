...
public class JavaProxy extends cfJavaObjectData{

	private static final long serialVersionUID = 1L;

	public JavaProxy( Class<?> _class ){
		super( new cfSession(new dummyServletRequest(), new dummyServletResponse(), cfEngine.thisServletContext), _class );
	}
