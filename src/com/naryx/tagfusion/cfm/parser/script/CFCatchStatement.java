...
public class CFCatchStatement extends cfCatchClause implements CFScriptStatement, java.io.Serializable{
	private static final long serialVersionUID = 1L;
	
	private String var;
	private CFScriptStatement body;
	private cfTag	parent;
	...
	@Override
	public void setHostTag(cfTag parentTag) {
		parent	= parentTag;
		body.setHostTag( parentTag );
	}
