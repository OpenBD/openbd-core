 ...
 *  
 *  http://openbd.org/
 *  $Id: CacheIDExists.java 2131 2012-06-27 19:02:26Z alan $
 */
...
public class CacheIDExists extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		return cfBooleanData.getcfBooleanData( CacheFactory.getCacheEngine(region).get( id ) != null );
	}
}
