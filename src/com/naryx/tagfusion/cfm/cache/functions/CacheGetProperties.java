 ...
 *  
 *  http://openbd.org/
 *  $Id: CacheGetProperties.java 2131 2012-06-27 19:02:26Z alan $
 */
...
public class CacheGetProperties extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		if ( CacheFactory.isCacheEnabled(region) )
			return CacheFactory.getCacheEngine(region).getProperties();
		else
			throwException(_session, "No such region: " + region );
