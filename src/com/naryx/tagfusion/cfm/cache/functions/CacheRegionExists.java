 ...
 *  
 *  http://openbd.org/
 *  $Id: CacheRegionExists.java 2131 2012-06-27 19:02:26Z alan $
 */
...
public class CacheRegionExists extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		return cfBooleanData.getcfBooleanData( CacheFactory.isCacheEnabled(region) );
	}
}