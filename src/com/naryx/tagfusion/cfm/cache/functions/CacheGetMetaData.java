 ...
 *  
 *  http://openbd.org/
 *  $Id: CacheGetMetaData.java 2131 2012-06-27 19:02:26Z alan $
 */
...
public class CacheGetMetaData extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		if ( CacheFactory.isCacheEnabled(region) )
			return CacheFactory.getCacheEngine(region).getStats();
		else
