 ...
 *
 *  http://openbd.org/
 *  $Id: cfCGIData.java 2378 2013-06-10 23:08:14Z alan $
 */
...
public class cfCGIData extends cfStructData implements java.io.Serializable{
  ...
  static final long serialVersionUID = 1;
	...
	private static final String cgiConstants[] =	{
		"SERVER_SOFTWARE",
		"SERVER_NAME",
		"GATEWAY_INTERFACE",
		"SERVER_PROTOCOL",
	...
	public cfData getData( String _key ){
		...
		if ( index != null )
		{
			...
			{
				case 0 : return new cfStringData( REQ.getRemoteAddr() );
				case 1 : return new cfStringData( REQ.getRemoteHost() );
				case 2 : return new cfStringData( CTX.getServerInfo() );
				case 3 : return new cfStringData( REQ.getServerName() );
				case 4 : return new cfStringData( REQ.getServerPort() + "" );
				case 5 : return new cfStringData( REQ.getContentLength()+ "" );
				case 6 : return new cfStringData( REQ.getContentType() );
				case 7 : return new cfStringData( REQ.getProtocol() );
				case 8 : return new cfStringData( REQ.getPathInfo() );
				case 9 : return new cfStringData( REQ.getRequestURI() );
				...
				case 11 : return new cfStringData( cfUrlData.getQueryString(_session) );
				case 12 : return new cfStringData( REQ.getAuthType() );
				case 13 : return new cfStringData( REQ.getMethod() );
				case 14 : return new cfStringData( REQ.getRemoteUser() );
				case 15 : return new cfStringData( REQ.getContextPath() + REQ.getServletPath() );
				case 16 : return new cfStringData( REQ.getContextPath() );
				case 17 : return new cfStringData( REQ.isSecure() ? "on" : "off" );
				case 18 : return new cfStringData( getCanonicalPath( REQ, REQ.getServletPath() ) );
				case 19 : return new cfStringData( REQ.isSecure() ? "1" : "0" );
				case 20 : // user_agent
		...
		if ( oldHdr != null ) {
			return new cfStringData( REQ.getHeader( oldHdr ) );
		}
