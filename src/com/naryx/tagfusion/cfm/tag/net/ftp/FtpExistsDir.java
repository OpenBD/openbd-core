 ...
 *  
 *  http://openbd.org/
 *  $Id: FtpExistsDir.java 2275 2012-09-04 00:20:26Z alan $
 */
...
public class FtpExistsDir extends FtpClose {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		String	file		= getNamedStringParam(argStruct, "directory", "/" );
		...
		try{
			...
			return cfBooleanData.getcfBooleanData( files[0].isDirectory() );
