 ...
 *  
 *  http://openbd.org/
 *  $Id: FtpGetCurrentUrl.java 2275 2012-09-04 00:20:26Z alan $
 */
...
public class FtpGetCurrentUrl extends FtpClose {
	private static final long serialVersionUID = 1L;

	public FtpGetCurrentUrl() {
		min = 1; max = 2;
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		try{
			...
			curDir 	= "ftp://" + ftpdata.getServer() + curDir.replace('\\','/');
