 ...
 *  
 *  http://openbd.org/
 *  $Id: FtpExistsFile.java 2275 2012-09-04 00:20:26Z alan $
 */
...
public class FtpExistsFile extends FtpClose {
	private static final long serialVersionUID = 1L;

	public FtpExistsFile() {
		min = 2; max = 4;
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		if ( file == null )
			throwException(_session, "missing 'file' attribute");
		...
		try{
			...
			return cfBooleanData.getcfBooleanData( files[0].isFile() );
