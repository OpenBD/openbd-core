 ...
 *  
 *  http://openbd.org/
 *  $Id: FtpSetCurrentDir.java 2275 2012-09-04 00:20:26Z alan $
 */
...
public class FtpSetCurrentDir extends FtpClose {
	private static final long serialVersionUID = 1L;

	public FtpSetCurrentDir() {
		min = 2; max = 3;
	...
	public String[] getParamInfo(){
		return new String[]{
			...
			"the directory to set the remote server to",
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		try{
			...
			bResult = ftpdata.setCurrentDirectory(directory);
