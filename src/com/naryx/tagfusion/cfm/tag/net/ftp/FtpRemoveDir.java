 ...
 *  
 *  http://openbd.org/
 *  $Id: FtpRemoveDir.java 2275 2012-09-04 00:20:26Z alan $
 */
...
public class FtpRemoveDir extends FtpClose {
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"ftp", 
				"Removes the directory on the remote server", 
				ReturnType.BOOLEAN );
	}
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		try{
			...
			boolean bSuccess = ftpdata.removeDirectory(file);
