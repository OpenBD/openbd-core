...
public class getSOAPResponse extends functionBase {

	private static final long serialVersionUID = 1L;

	public getSOAPResponse() {
		super.min = 0;
		super.max = 1;
	}
	...
	public cfData execute(cfSession _session, List<cfData> parameters) throws cfmRunTimeException {
		...
		if (wso.getInvoked() && wso.getResponseXml() != null)
			return new cfXmlData((Document) wso.getResponseXml(), true);
		else
