...
public class toBinary extends functionBase {
 
  private static final long serialVersionUID = 1L;
	
  public toBinary(){ min = max = 1; setNamedParams( new String[]{ "string" } );}
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		if ( data.getDataType() == cfData.CFBINARYDATA )
			...
			return new cfBinaryData( Base64.base64Decode( data.getString().replaceAll("[\\r\\n]", "").getBytes() ) );	
	}
}
