 ...
 *  http://openbd.org/
 *  
 *  $Id: directoryExists.java 1690 2011-09-26 09:38:42Z alan $
 */
...
public class directoryExists extends functionBase {
  ...
  public cfData execute( cfSession _session, List<cfData> parameters )throws cfmRunTimeException{    
  	...
  	try{
  		...
  		vfsData.populateInfo();
  		boolean bIsDir	= vfsData.getData("type").getString().equals("directory");
  		return cfBooleanData.getcfBooleanData( bIsDir && vfsData.exists() );
  	}catch(Exception e){
