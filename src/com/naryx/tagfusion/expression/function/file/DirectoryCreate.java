 ...
 *  http://openbd.org/
 *  
 *  $Id: DirectoryCreate.java 1690 2011-09-26 09:38:42Z alan $
 */
...
public class DirectoryCreate extends functionBase {
  private static final long serialVersionUID = 1L;

  public DirectoryCreate(){ min = max = 1; }
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"file", 
				"Creates a directory on the file system given {supports Amazon S3}", 
				ReturnType.BOOLEAN );
	}
  ...
  public cfData execute( cfSession _session, List<cfData> parameters )throws cfmRunTimeException{
  	...
  	try{
  		...
  		if ( !vfsData.isNative() )
  			vfsData.getFileObject().createFolder();
  		else
  			vfsData.getFile().mkdirs();
