 ...
 *  http://openbd.org/
 *  
 *  $Id: FileExists.java 1690 2011-09-26 09:38:42Z alan $
 */
...
public class FileExists extends functionBase {
  private static final long serialVersionUID = 1L;

  public FileExists(){ min = max = 1; }
  ...
  public String[] getParamInfo(){
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"file", 
				"Determine if the file exists {supports Amazon S3}", 
				ReturnType.BOOLEAN );
	}
  ...
  public cfData execute( cfSession _session, List<cfData> parameters )throws cfmRunTimeException{
  	...
  	try{
  		...
  		return cfBooleanData.getcfBooleanData( vfsData.exists() );
  	}catch(Exception e){
