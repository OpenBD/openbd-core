...
public class htmlBody extends functionBase {
  ...
  public String[] getParamInfo(){
		return new String[]{
			...
			"indicator to where it should be added; APPEND|PREPEND controls where you wish the body text to appear within the body area"
		};
	}
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		_session.setBodyElement( text, position.equalsIgnoreCase("APPEND") );
