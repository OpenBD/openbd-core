...
public class listLast extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		String list = getNamedStringParam( argStruct, "list" , null );
		String delimiter = getNamedStringParam( argStruct, "delimiter" , "," );

		List<String> valist = string.split(list, delimiter);
		return new cfStringData(valist.size() > 0 ? valist.get(valist.size() - 1) : "");
	}
}
