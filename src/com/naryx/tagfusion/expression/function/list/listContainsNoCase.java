...
public class listContainsNoCase extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		String list = getNamedStringParam( argStruct, "list" ,"" ).toLowerCase();
		String substring = getNamedStringParam( argStruct, "substring" ,"" ).toLowerCase();
		String delimiter = getNamedStringParam( argStruct, "delimiter" ,"," ).toLowerCase();
