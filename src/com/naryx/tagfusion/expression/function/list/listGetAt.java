...
public class listGetAt extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		if (position <= tokens.size()) {
			return new cfStringData(tokens.get(position - 1));
		}

		throwException(_session, "The list has " + tokens.size() + " elements.  You requested element: " + position);
		return null;
	}
}
