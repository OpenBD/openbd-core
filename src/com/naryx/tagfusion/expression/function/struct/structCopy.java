...
public class structCopy extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		if (struc instanceof cfXmlData)
			return ((cfXmlData) struc).duplicate();
		else if (struc instanceof cfCookieData)
			return ((cfCookieData) struc).duplicate();
		else if (struc.isStruct()) {
			return new cfStructData(((cfStructData) struc).copy());
		} else {
