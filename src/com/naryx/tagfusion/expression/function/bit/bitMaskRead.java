...
public class bitMaskRead extends functionBase {
 
  private static final long serialVersionUID = 1L;
	
  public bitMaskRead(){ min = max = 3; }
  ...
  public cfData execute( cfSession _session, List<cfData> parameters ) throws cfmRunTimeException{
		int number 	= getInt( _session, parameters.get(2) );
    ...
    return new cfNumberData( (number & mask) >> start );
  } 
}
