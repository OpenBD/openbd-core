...
public class ImageDrawRoundRect extends ImageInfo {
	private static final long serialVersionUID = 1L;


	public ImageDrawRoundRect() {
		min = 7; max = 8;
		setNamedParams( new String[]{ "name", "x", "y", "width", "height", "arcwidth", "archeight", "filled" } );
	}
	...
	public String[] getParamInfo() {
		return new String[] { 
				...
				"the horizontal diameter of the corner",
				"the vertical diameter of the corner",
