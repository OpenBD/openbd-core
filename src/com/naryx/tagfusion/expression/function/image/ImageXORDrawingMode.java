...
public class ImageXORDrawingMode extends ImageInfo {
	private static final long serialVersionUID = 1L;

	public ImageXORDrawingMode() {
		min = max = 2;
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
		...
		String color	= getNamedStringParam(argStruct, "color", "");
		
		im.setXORColor( colour.getColor(color) );
