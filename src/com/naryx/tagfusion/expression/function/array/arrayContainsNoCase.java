...
public class arrayContainsNoCase extends arrayFindNoCase  {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		cfData	result	= super.execute( _session, argStruct );
		return result.getInt() > 0 ? cfBooleanData.TRUE : cfBooleanData.FALSE;
	}
}
