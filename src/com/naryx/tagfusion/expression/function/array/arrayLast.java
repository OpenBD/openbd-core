...
public class arrayLast extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct) throws cfmRunTimeException {
		...
		if (array.getDataType() == cfData.CFARRAYDATA) {
			return ((cfArrayData) array).getElement( ((cfArrayData) array).size() );
			...
			return new cfNumberData( ((cfBinaryData)array).getByteAt( ((cfBinaryData)array).getLength()-1 ) );
		} else
