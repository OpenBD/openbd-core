...
/**
 * The <B>replaceNoCase</B> replaceNoCase function. 
 */
...
public class replaceNoCase extends functionBase {
  ...
  public replaceNoCase(){ 
    ...
    if ( scope.equalsIgnoreCase( "ONE" ) ){
 			result = com.nary.util.string.replaceStringIgnoreCase( str, sub1, sub2, false );    
    }else if ( scope.equalsIgnoreCase( "ALL" ) ){
 			result = com.nary.util.string.replaceStringIgnoreCase( str, sub1, sub2, true );
 	  }	
