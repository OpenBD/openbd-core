...
public class lJustify extends functionBase {
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		String value = getNamedStringParam(argStruct, "string", "").trim();
		int space = getNamedIntParam(argStruct, "length", -1);

		if (space <= value.length())
			return new cfStringData(value);

		return new cfStringData(string.justify(string.LEFT, space, value));
	}
}
