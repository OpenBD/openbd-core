...
public class urlDecode extends functionBase {
  ...
  public String[] getParamInfo(){
	...
	public cfData execute(cfSession _session, List<cfData> parameters) throws cfmRunTimeException {
		...
		if (charsetSpecified) {
			...
			encoding = ((cfUrlData) _session.getQualifiedData(variableStore.URL_SCOPE)).getEncoding();
		}

		String temp = RequestUtil.URLDecode(data.getBytes(), com.nary.util.Localization.convertCharSetToCharEncoding(encoding));
		return new cfStringData(temp);
	}
}
