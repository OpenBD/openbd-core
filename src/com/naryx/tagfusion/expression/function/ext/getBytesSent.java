...
public class getBytesSent extends functionBase {
  ...
  public java.util.Map getInfo(){
		return makeInfo(
				"engine", 
				"Returns the number of bytes sent to the client request at this point", 
				ReturnType.NUMERIC );
	}
  
  public cfData execute( cfSession _session, List<cfData> parameters ) throws cfmRunTimeException{
  	return new cfNumberData( _session.getBytesSent()  );
  }
}
