...
public class ThreadStop extends functionBase {
	
	private static final long serialVersionUID = 1;
    
	public ThreadStop() { min = 1; max = 1; }
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"thread", 
				"Terminates the running thread object", 
				ReturnType.THREAD );
	} 
	...
	public cfData execute( cfSession _session, List<cfData> parameters ) throws cfmRunTimeException {
		...
		if ( parm0 instanceof cfThreadData ) {
			cfThreadRunner thread = ((cfThreadData)parm0).getThread();
			thread.stopThread();
			return parm0;
		}
