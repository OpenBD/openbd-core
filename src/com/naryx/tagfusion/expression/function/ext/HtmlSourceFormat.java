...
public class HtmlSourceFormat extends functionBase {
  
  private static final long serialVersionUID = 1L;
	
  public HtmlSourceFormat(){ 
  	min = 1; max = 1;
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
  	...
  	try{
  		...
  		return new cfStringData( new SourceFormatter(source).setIndentString("  ").setTidyTags(true).setCollapseWhiteSpace(true).toString() );
  	}catch( Exception e ){
