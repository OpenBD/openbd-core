...
public class LSIsDate extends functionBase {
  ...
  public cfData execute( cfSession _session, List<cfData> parameters )throws cfmRunTimeException{
    cfData d1 = parameters.get(0);
    	...
    	cfDateData date = LSParseDateTime.isDateTime( d1.getString(),_session.getLocale());
      return cfBooleanData.getcfBooleanData( date != null );
    }
	}
}
