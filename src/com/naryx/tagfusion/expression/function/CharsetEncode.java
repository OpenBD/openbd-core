...
public class CharsetEncode extends functionBase {
  ...
  public CharsetEncode(){  
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
  	...
  	byte [] bytes = ( (cfBinaryData)binData ).getByteArray();

  	try {
			return new cfStringData( new String( bytes, Localization.convertCharSetToCharEncoding( encoding ) ) );
