...
public class MongoDeRegister extends functionBase {
	private static final long serialVersionUID = 1L;

	public MongoDeRegister(){  min = 1; max = 1; setNamedParams( new String[]{ "datasource" } ); }
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		MongoExtension.remove( datasource );
