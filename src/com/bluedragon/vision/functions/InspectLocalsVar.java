...
public class InspectLocalsVar extends functionBase {
	private static final long serialVersionUID = 1L;

	public InspectLocalsVar(){
		min = max = 1;
	}
	...
	public cfData execute( cfSession _session, List<cfData> parameters )throws cfmRunTimeException { 
	  ...
	  if ( ds == null ){
		...
		cfStructData locals	= ds.getCFSession().getLocalScope();
		if ( locals != null )
			return locals;
		else{
			throwException(_session, "not inside cfc" );
			return null;
		}
	}
}
