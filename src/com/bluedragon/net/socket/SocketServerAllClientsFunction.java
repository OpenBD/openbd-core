 ...
 *  
 *  http://openbd.org/
 *  $Id: SocketServerAllClientsFunction.java 1903 2011-12-30 20:46:20Z alan $
 */
...
public class SocketServerAllClientsFunction extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public SocketServerAllClientsFunction() {
		min = 1;
		max = 1;
	...
	public cfData execute(cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException {
		...
		cfArrayData	array	= SocketServerDataFactory.thisInst.getClients(port);
		if ( array == null )
