...
public class CustomStackedBarRenderer extends StackedBarRenderer implements CustomColorRenderer {
	 ...
	 *          the colors.
	 */
	public CustomStackedBarRenderer(Paint[] colors) {
		this.colors.addElement(colors);
	}

	public CustomStackedBarRenderer(Paint[] colors, boolean percent) {
		super(percent);
		this.colors.addElement(colors);
	}
