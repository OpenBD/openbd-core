...
public class CustomStackedBarRenderer3D extends StackedBarRenderer3D implements CustomColorRenderer {
	 ...
	 *          the colors.
	 */
	public CustomStackedBarRenderer3D(Paint[] colors, int xOffset, int yOffset) {
