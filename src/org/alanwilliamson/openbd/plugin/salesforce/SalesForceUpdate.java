 ...
 *  
 *  $Id: SalesForceUpdate.java 2131 2012-06-27 19:02:26Z alan $
 */
...
public class SalesForceUpdate extends SalesForceBaseFunction {
	private static final long serialVersionUID = 1L;

	public SalesForceUpdate(){
		min = 5; max = 6;
		setNamedParams( new String[]{ "email", "passwordtoken", "type", "id", "fields", "timeout" } );
	}
