...
public class IsSpreadsheetObject extends functionBase {
	private static final long serialVersionUID = 1L;

	public IsSpreadsheetObject(){  min = 1; max = 1; }
  ...
  public cfData execute( cfSession _session, List<cfData> parameters ) throws cfmRunTimeException {
  	return cfBooleanData.getcfBooleanData( parameters.get(0) instanceof cfSpreadSheetData );
  }
}
