...
public class SpreadsheetDeleteRow extends functionBase {
	private static final long serialVersionUID = 1L;

	public SpreadsheetDeleteRow(){  min = 2;  max = 2; }
  
	public String[] getParamInfo(){
		return new String[]{
			"spreadsheet object",
			"row no - expressed as either a list of numbers or a range (2,3,5-9)"
		};
	}
