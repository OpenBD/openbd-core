...
public class SpreadsheetCreateSheet extends functionBase {
	private static final long serialVersionUID = 1L;

	public SpreadsheetCreateSheet(){  min = 2;  max = 2; }
  ...
  public cfData execute( cfSession _session, List<cfData> parameters ) throws cfmRunTimeException {
  	...
  	String	sheet									= parameters.get(0).getString(); 
  	
  	spreadsheet.getWorkBook().createSheet( sheet );
