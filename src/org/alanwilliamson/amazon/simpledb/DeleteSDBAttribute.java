...
public class DeleteSDBAttribute extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public DeleteSDBAttribute(){  
		min = 4; max = 5; 
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
  	...
  	String attValue		= getNamedStringParam(argStruct, "attvalue", null );
  	...
  	try {
  		...
  		sdb.deleteAttributes( domainName, itemName, map );
