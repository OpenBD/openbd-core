 ...
 *  
 *  http://openbd.org/
 *  $Id: ChangeObjectStorageClass.java 2529 2015-03-01 23:39:29Z alan $
 */
...
public class ChangeObjectStorageClass extends AmazonBase {
	private static final long serialVersionUID = 1L;
	
	public ChangeObjectStorageClass(){  min = 4; max = 4; setNamedParams( new String[]{ "datasource", "bucket", "key", "storageclass" } ); }
	...
	public String[] getParamInfo(){
		return new String[]{
			...
			"Amazon bucket",
			"key to the object",
			"storage class - Standard or ReducedRedundancy"
		};
	}
	...
	public java.util.Map<String,String> getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon S3: Changes the Amazon S3 storage class for a specified object", 
				ReturnType.BOOLEAN );
	}
