 ...
 *  
 *  http://openbd.org/
 *  $Id: ExistsBucket.java 2466 2015-01-11 15:53:09Z alan $
 */
...
public class ExistsBucket extends AmazonBase {
	private static final long serialVersionUID = 1L;
	
	public ExistsBucket(){  min = 2; max = 2; setNamedParams( new String[]{ "datasource","bucket" } ); }

	public String[] getParamInfo(){
		return new String[]{
			"Amazon datasource",
			"name for the bucket to check"
		};
	}
