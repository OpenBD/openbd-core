...
public class Write extends AmazonBase {
	...
	public String[] getParamInfo() {
		return new String[] {
				...
				"optional AES256 key for Amazon to encrypt the file at rest, using the specified key, in Base64.  If you write the file using encryption, then you have to supply the same key in the AmazonS3Read() function to read the file.  To create a AES key use the OpenBD function:  GenerateSecretKey('aes',256)",
