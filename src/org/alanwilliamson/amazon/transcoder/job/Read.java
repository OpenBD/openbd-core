...
public class Read extends AmazonBase {
	...
	public Read(){  min = 2; max = 2; setNamedParams( new String[]{ "datasource", "jobid" } ); }
	...
	public java.util.Map<String,String> getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon Elastic Transcoder: Reads the status of a job (Submitted, Progressing, Complete, Canceled, or Error)",
				ReturnType.STRING );
	}
