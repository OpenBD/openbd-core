 ...
 *  
 *  http://openbd.org/
 *  $Id: List.java 2477 2015-01-18 23:08:53Z alan $
 */
...
public class List extends AmazonBase {
	...
	public List(){  min = 2; max = 2; setNamedParams( new String[]{ "datasource","pipelineid" } ); }
	...
	public java.util.Map<String,String> getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon Elastic Transcoder: Lists all the jobs for this pipeline", 
				ReturnType.ARRAY );
	}
