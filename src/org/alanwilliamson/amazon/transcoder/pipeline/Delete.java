 ...
 *  
 *  http://openbd.org/
 *  $Id: Delete.java 2476 2015-01-18 23:00:40Z alan $
 */
...
public class Delete extends AmazonBase {
	...
	public Delete(){  min = 2; max = 2; setNamedParams( new String[]{ "datasource", "pipelineid" } ); }
	...
	public java.util.Map<String,String> getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon Elastic Transcoder: Deletes a pipeline.  You can only delete a pipeline that has never been used or that is not currently in use (doesn't contain any active jobs).", 
				ReturnType.BOOLEAN );
	}
