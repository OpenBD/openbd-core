...
public class RemovePermission extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public RemovePermission(){ 
		min = 3; max = 3; 
		setNamedParams( new String[]{ "datasource", "queueurl", "label" } );
	}
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon SQS: Removes the given label permission from the queue", 
				ReturnType.BOOLEAN );
	}
