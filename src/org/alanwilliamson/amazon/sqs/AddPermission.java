...
public class AddPermission extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public AddPermission(){  min = 5; max = 5; 
	setNamedParams( new String[]{ "datasource", "queueurl", "label", "amzid", "permission" } );
	}
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon SQS: Adds the given permission to the queue within the account", 
				ReturnType.BOOLEAN );
	}
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
 		...
 		String amzid			= getNamedStringParam(argStruct, "amzid", "" );
 		String perm				= getNamedStringParam(argStruct, "permission", "" );
  	...
  	try {
  		sqs.addPermission( queueurl, label, amzid, perm ); 		
