...
public class ListQueues extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public ListQueues(){  min = 1; max = 1; setNamedParams( new String[]{ "datasource" } ); }
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon SQS: Returns all the queues for this account", 
				ReturnType.QUERY );
	}
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
  	...
  	try {
  		...
  		//Create the results
  		cfQueryResultData qD = new cfQueryResultData( new String[]{"queue"}, null );
  		qD.setQuerySource( "AmazonSQS." + dsName );
  		  		
  		for ( Iterator<String> it = queues.iterator(); it.hasNext(); ){
  			String d = it.next();
