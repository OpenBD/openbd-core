...
public class ChangeMessageVisibility extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public ChangeMessageVisibility(){ 
		min = 4; max = 4; 
		setNamedParams( new String[]{ "datasource", "queueurl", "messagereceipt", "visibility" } );
	}
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon SQS: Changes the visibility of the given message by the value given", 
				ReturnType.BOOLEAN );
	}
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
  	...
  	String messReceipt	= getNamedStringParam(argStruct, "messagereceipt", "");
  	int Visibility 			= getNamedIntParam(argStruct, "visibility", 30 );
  	...
  	try {
  		sqs.changeMessageVisibility( queueurl, messReceipt, Visibility ); 		
