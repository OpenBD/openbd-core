...
public class DeleteMessage extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public DeleteMessage(){ 
		min = 3; max = 3; 
		setNamedParams( new String[]{ "datasource", "queueurl", "messagereceipt" } );
	}
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon SQS: Deletes the message on the queue", 
				ReturnType.STRING );
	}
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
  	...
  	try {
  		sqs.deleteMessage( queueurl, messReceipt ); 		
