...
public class AmazonRemoveDatasource extends functionBase {
	private static final long serialVersionUID = 1L;
	
	public AmazonRemoveDatasource(){  
		min = max = 1; 
	...
	public java.util.Map getInfo(){
		return makeInfo(
				"amazon", 
				"Amazon Datasource: Removes a previously registered datasource", 
				ReturnType.STRING );
	}
	...
	public cfData execute( cfSession _session, cfArgStructData argStruct ) throws cfmRunTimeException{
  	...
  	AmazonKeyFactory.removeDS( dsName );
