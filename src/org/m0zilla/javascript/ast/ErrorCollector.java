...
import org.m0zilla.javascript.EvaluatorException;

/**
 * An error reporter that gathers the errors and warnings for later display.
 * This a useful {@link org.m0zilla.javascript.ErrorReporter} when the
 * {@link org.m0zilla.javascript.CompilerEnvirons} is set to
 * ide-mode (for IDEs).
 *
 * @author Steve Yegge
 */
