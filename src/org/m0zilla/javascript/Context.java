...
import org.m0zilla.javascript.debug.DebuggableScript;
import org.m0zilla.javascript.debug.Debugger;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(org.m0zilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "org.m0zilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "org.m0zilla.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(org.m0zilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see org.m0zilla.javascript.ErrorReporter
     */
     ...
     * @see org.m0zilla.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (org.m0zilla.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see org.m0zilla.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "org.m0zilla.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "org.m0zilla.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "org.m0zilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
