...
public abstract class RhinoException extends RuntimeException {
	 ...
	 * 
	 * @param sourceName
	 *          the uri of the script source responsible for the error. It should not be <tt>null</tt>.
	 * 
	 ...
	 * 
	 * @param lineNumber
	 *          the line number in the script source. It should be positive number.
	 * 
	 * @throws IllegalStateException
	 *           if the method is called more then once.
	 */
	 ...
	 * 
	 * @param columnNumber
	 *          the column number in the script source. It should be positive number.
	 * 
	 * @throws IllegalStateException
	 *           if the method is called more then once.
	 */
	 ...
	 * 
	 * @param lineSource
	 *          the text of the source line responsible for the error. It should not be <tt>null</tt>.
	 * 
	 * @throws IllegalStateException
	 *           if the method is called more then once.
	 */
	...
	/**
	 * Get the script stack of this exception as an array of {@link ScriptStackElement}s. If optimization is enabled, this includes java stack elements whose source and method names suggest they have been generated by the Rhino script compiler.
	 * 
	...
	public ScriptStackElement[] getScriptStack() {
		...
		for (StackTraceElement e : stack) {
			...
			} else if ("org.m0zilla.javascript.Interpreter".equals(e.getClassName()) && "interpretLoop".equals(e.getMethodName()) && interpreterStack != null && interpreterStack.length > interpreterStackIndex) {
	...
	/**
	 * Returns true if subclasses of <code>RhinoException</code> use the Mozilla/Firefox style of rendering script stacks (<code>functionName()@fileName:lineNumber</code>) instead of Rhino's own Java-inspired format (<code>    at fileName:lineNumber (functionName)</code>).
	 * 
	...
	/**
	 * Tell subclasses of <code>RhinoException</code> whether to use the Mozilla/Firefox style of rendering script stacks (<code>functionName()@fileName:lineNumber</code>) instead of Rhino's own Java-inspired format (<code>    at fileName:lineNumber (functionName)</code>)
	 * 
	 * @param flag
