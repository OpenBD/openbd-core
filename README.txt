Open BlueDragon 
  Java J2EE/GoogleAppEngine CFML Runtime Engine
    (c) Copyright 2000 - 2015 aw2.0 Ltd
    http://openbd.org/
...
Additional Permission Granted by tagServlet Ltd: 
  aw2.0 Ltd grants the user the exception to distribute the entire 
...
You will require the following to be able to build OpenBD from source:
  ...
  x Java Developers Kit Virtual Machine 8
